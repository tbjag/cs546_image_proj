...
var healthcare_v1alpha2;
(function (healthcare_v1alpha2) {
    /**
    ...
    healthcare_v1alpha2.Healthcare = Healthcare;
    ...
    healthcare_v1alpha2.Resource$Projects = Resource$Projects;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations = Resource$Projects$Locations;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets = Resource$Projects$Locations$Datasets;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Annotationstores = Resource$Projects$Locations$Datasets$Annotationstores;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Annotationstores$Annotations = Resource$Projects$Locations$Datasets$Annotationstores$Annotations;
    class Resource$Projects$Locations$Datasets$Dicomstores {
        ...
        import(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const rootUrl = options.rootUrl || 'https://healthcare.googleapis.com/';
            const parameters = { options: Object.assign({ url: (rootUrl + '/v1alpha2/{+name}:import').replace(/([^:]\/)\/+/g, '$1'), method: 'POST' }, options), params, requiredParams: ['name'], pathParams: ['name'], context: this.context };
            if (callback) {
                googleapis_common_1.createAPIRequest(parameters, callback);
            }
            else {
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Dicomstores = Resource$Projects$Locations$Datasets$Dicomstores;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb = Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies = Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Series = Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Series;
    class Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Series$Instances {
        constructor(context) {
            this.context = context;
            this.frames =
                new Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Series$Instances$Frames(this.context);
        }
        delete(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback || {});
            let options = (optionsOrCallback || {});
        ...
        rendered(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback || {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Series$Instances = Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Series$Instances;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Series$Instances$Frames = Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Series$Instances$Frames;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Fhirstores = Resource$Projects$Locations$Datasets$Fhirstores;
    class Resource$Projects$Locations$Datasets$Fhirstores$Fhir {
        constructor(context) {
            this.context = context;
            this.Patient =
                new Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Patient(this.context);
            this._history =
                new Resource$Projects$Locations$Datasets$Fhirstores$Fhir$_history(this.context);
        }
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Fhirstores$Fhir = Resource$Projects$Locations$Datasets$Fhirstores$Fhir;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Patient = Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Patient;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Fhirstores$Fhir$_history = Resource$Projects$Locations$Datasets$Fhirstores$Fhir$_history;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Fhirstores$Securitylabels = Resource$Projects$Locations$Datasets$Fhirstores$Securitylabels;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Hl7v2stores = Resource$Projects$Locations$Datasets$Hl7v2stores;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Hl7v2stores$Messages = Resource$Projects$Locations$Datasets$Hl7v2stores$Messages;
    ...
    healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Operations = Resource$Projects$Locations$Datasets$Operations;
})(healthcare_v1alpha2 = exports.healthcare_v1alpha2 || (exports.healthcare_v1alpha2 = {}));

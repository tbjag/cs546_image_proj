...
(function (cloudiot_v1) {
        ...
        bindDeviceToGateway(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}:bindDeviceToGateway')
                        .replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST'
                }, options),
                params,
    ...
    class Resource$Projects$Locations$Registries$Groups$Devices {
        constructor(context) {
            this.context = context;
            this.configVersions =
                new Resource$Projects$Locations$Registries$Groups$Devices$Configversions(this.context);
            this.states =
                new Resource$Projects$Locations$Registries$Groups$Devices$States(this.context);
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback || {});
            let options = (optionsOrCallback || {});
